...
public class ShowRegionActivity extends AppCompatActivity{
    ...
    Button quxiao_btn,queding_btn;
    EditText detailAddress_et;
    Spinner spinner_sheng,spinner_shi,spinner_qu;//省市区
    ...
    private void setSpinnerData() {
        ...
        for (int i = 0; i < allProv.length; i++) {
            //给spinner省赋值,设置默认值
            if (address != null && !address.equals("") && allAddress != null &&
                    !allAddress.equals("")&& allSpinList.length > 0 && allSpinList[0].equals(allProv[i])) {
                selectPosition = i;
            }
        ...
        spinner_sheng.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isFirstLoad) {
                    // 判断是否省市区都存在
                    if (address != null && !address.equals("") && allAddress != null &&
                            !allAddress.equals("")&& allSpinList.length > 1 && allSpinList.length < 3) {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (!isFirstLoad) {
                    ...
                    if (address != null && !address.equals("") && allAddress != null && !allAddress.equals("") && allSpinList.length == 4) {
                        detailAddress_et.setText(allSpinList[3]);//没有进入区的对话框，
                    }
                }
                isFirstLoad = false;
            }
    ...
    private void updateArea(Object object, Object myArea) {
        ...
        if (!isArea && ifSetFirstAddress && address != null && !address.equals("") && allAddress != null && !allAddress.equals("") && allSpinList.length == 3) {
            detailAddress_et.setText(allSpinList[2]);
    ...
    private void initOnclick() {
        ...
        queding_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //把值返回给MyshezhiActivity
                ...
                intent.putExtra("allAddress", detailAddress_et.getText().toString());
    ...
    private void initView() {
        ...
        queding_btn= (Button) this.findViewById(R.id.queding_btn);
        spinner_sheng= (Spinner) this.findViewById(R.id.spinner_sheng);
        spinner_shi= (Spinner) this.findViewById(R.id.spinner_shi);
        spinner_qu= (Spinner) this.findViewById(R.id.spinner_qu);
